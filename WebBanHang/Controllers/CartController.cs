    ...
    public class CartController : Controller
    {
        ...
        public ActionResult AddToCart(int id,int quantity )
        {
            if (Session["cart"] == null)
            {
                ...
                cart.Add(new CartModel { Product = webBanHangASP.Product_0242.Find(id), Quantity = quantity });
                Session["cart"] = cart;
                Session["count"] = 1;
            }
            else
        ...
        public ActionResult Remove(int Id)
        {
            ...
            return Json(new {data= Session["count"], Message = "Thành công", JsonRequestBehavior.AllowGet });
        }
    }
}